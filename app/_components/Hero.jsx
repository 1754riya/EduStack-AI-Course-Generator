    ...
    <section className="relative overflow-hidden bg-white min-h-[calc(100vh-64px)] flex items-center">
      ...
      <div className="absolute inset-0 pointer-events-none select-none">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 55% at 50% 0%, rgba(99,102,241,0.10), transparent 65%)",
          }}
        />
        <div
          className="absolute inset-0"
          style={{
            background:
              "radial-gradient(ellipse 50% 45% at 85% 90%, rgba(139,92,246,0.08), transparent 65%)",
          }}
        />
        <div
          className="absolute inset-0"
          style={{
            background:
              "radial-gradient(ellipse 50% 40% at 10% 80%, rgba(99,102,241,0.06), transparent 65%)",
          }}
        />
        ...
        <motion.div
          ...
          animate={
            reduced
              ? {}
              : { scale: [1, 1.09, 1], x: [0, 18, 0], y: [0, -14, 0] }
          }
        ...
        <motion.div
          ...
          animate={
            reduced
              ? {}
              : { scale: [1, 1.11, 1], x: [0, -12, 0], y: [0, 18, 0] }
          }
        ...
        <motion.div
          className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-64 rounded-full bg-indigo-200/25 blur-3xl"
        ...
        <motion.div
          className="absolute right-[8%] top-[18%] w-16 h-16 rounded-full border border-indigo-200/50"
        ...
        <motion.div
          className="absolute left-[6%] bottom-[22%] w-10 h-10 rounded-full border border-violet-200/40"
          animate={reduced ? {} : { rotate: -360 }}
        ...
        <motion.div
          className="absolute right-[18%] top-[30%] w-2.5 h-2.5 rounded-full bg-indigo-400/40"
          animate={reduced ? {} : { y: [0, -10, 0], opacity: [0.4, 0.7, 0.4] }}
          transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute left-[14%] top-[40%] w-2 h-2 rounded-full bg-violet-400/40"
      ...
      {/* ── Content ── */}
      <div className="relative z-10 mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:items-center w-full">
        <motion.div
        ...
        >
          ...
          <motion.p
            variants={item}
            className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed max-w-md mx-auto"
          >
